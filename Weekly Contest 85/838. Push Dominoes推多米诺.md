...
# In the beginning, 
# we simultaneously push some of the dominoes either to the left 
# or to the right.
# After each second, each domino 
# that is falling to the left pushes the adjacent domino on the left.
